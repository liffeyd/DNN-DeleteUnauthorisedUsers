...
namespace dwsDeleteSpamUsers.Data
{
    class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "dws_";
        ...
        public override void DeleteItems(int portalId)
        {
            return DataProvider.Instance().ExecuteNonQuery("dwsDeleteSpamUsers", portalId);
        }
